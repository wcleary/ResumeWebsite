...
public class testingGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        names = ObfuscatorFactory.getObfuscatorMap();
        List<String> key = ObfuscatorFactory.getObfuscatorList();
        for(String i : key){
            names.put(names.get(i), i);
            model2.addElement((String) names.get(i));
        }
        ...
        jLabel1.setText(bundle.getString("inputLable")); // NOI18N

        jLabel2.setText(bundle.getString("outputLable")); // NOI18N
        ...
        jLabel3.setText(bundle.getString("blacklistLable")); // NOI18N
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        for(int i=0; i < model1.getSize(); i++){
            temp = model1.get(i);
            obfuscators.add(names.get(temp));
        }
